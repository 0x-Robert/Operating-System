...
- Interupt나 Exception 발생시 하드웨어가 mode bit을 0으로 바꿈
...
* Device controller는 I/O가 끝났을 경우 interupt로 CPU에 그 사실을 알림
...
- 인터럽트 처리 루틴 (Interupt Service Routine, 인터럽트 핸들러), 해당 인터럽트를 처리하는 커널 함수
